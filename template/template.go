...
import (
	...
	errors2 "github.com/vafinvr/go-admin/modules/errors"
	...
	"github.com/vafinvr/go-admin/template/login"
...
type Component interface {
	...
	//
	// See:
	// https://github.com/vafinvr/go-admin/blob/master/template/login/theme1.tmpl#L32
	// https://github.com/vafinvr/go-admin/blob/master/template/login/list.go
	GetAssetList() []string
