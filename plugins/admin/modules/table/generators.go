...
import (
	...
	"github.com/vafinvr/go-admin/modules/collection"
	...
	selection "github.com/vafinvr/go-admin/template/types/form/select"
...
func (s *SystemTable) GetGenerateForm(ctx *context.Context) (generateTool Table) {
	...
	formList.AddField(lgWithScore("extra import package", "tool"), "extra_import_package", db.Varchar, form.Select).
		FieldOptions(types.FieldOptions{
			...
			{Text: "log", Value: "log"},
			{Text: "fmt", Value: "fmt"},
			{Text: "github.com/vafinvr/go-admin/modules/db/dialect", Value: "github.com/vafinvr/go-admin/modules/db/dialect"},
			{Text: "github.com/vafinvr/go-admin/modules/db", Value: "github.com/vafinvr/go-admin/modules/db"},
			{Text: "github.com/vafinvr/go-admin/modules/language", Value: "github.com/vafinvr/go-admin/modules/language"},
			{Text: "github.com/vafinvr/go-admin/modules/logger", Value: "github.com/vafinvr/go-admin/modules/logger"},
		}).
		FieldDefault("").
